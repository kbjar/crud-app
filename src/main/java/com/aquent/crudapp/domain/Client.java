...
public class Client {
    ...
    @NotNull
    @Size(min = 1, max = 50, message = "Client name is required with length 100 ")
    private String name;

    @NotNull
    @Size(min = 3, max = 50, message = "Website URI is required with length 100")
    // is 3 the shortest? ex: a.co
